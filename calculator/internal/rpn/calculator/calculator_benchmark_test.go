...
func Benchmark_1k(b *testing.B) {
	equation := loadTestdata(b, "../testdata/src/halimath/1k")
	for i := 0; i < b.N; i++ {
		Calculate(equation)
	}
}
...
func Benchmark_10k(b *testing.B) {
	equation := loadTestdata(b, "../testdata/src/halimath/10k")
	for i := 0; i < b.N; i++ {
		Calculate(equation)
	}
}
...
func Benchmark_100k(b *testing.B) {
	equation := loadTestdata(b, "../testdata/src/halimath/100k")
	for i := 0; i < b.N; i++ {
		Calculate(equation)
	}
}
...
func Benchmark_1000k(b *testing.B) {
	equation := loadTestdata(b, "../testdata/src/halimath/1m")
	for i := 0; i < b.N; i++ {
		Calculate(equation)
	}
}
...
func Benchmark_10000k(b *testing.B) {
	equation := loadTestdata(b, "../testdata/src/halimath/10m")
	for i := 0; i < b.N; i++ {
		Calculate(equation)
	}
}

func loadTestdata(b *testing.B, file string) string {
